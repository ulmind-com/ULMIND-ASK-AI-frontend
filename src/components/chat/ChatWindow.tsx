...
export function ChatWindow() {
  ...
  return (
    <div className="w-[380px] h-[600px] flex flex-col bg-[#0a0a0a]/90 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden shadow-rose-900/20">
      ...
      <div className="flex items-center justify-between px-5 py-4 border-b border-white/10 bg-white/5">
        ...
        <div className="flex gap-2">
          <button 
            onClick={() => window.open(process.env.NEXT_PUBLIC_WHATSAPP_LINK || 'https://wa.me/918537861040', '_blank')}
