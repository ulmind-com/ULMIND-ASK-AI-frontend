  ...
  const supportOptions = [
    {
      ...
      link: process.env.NEXT_PUBLIC_WHATSAPP_LINK || 'https://wa.me/918537861040',
    },
    {
      title: 'Phone Call',
      ...
      link: `tel:${process.env.NEXT_PUBLIC_PHONE_NUMBER || '+918537861040'}`,
    },
    {
      title: 'Email Support',
      ...
      link: `mailto:${process.env.NEXT_PUBLIC_SUPPORT_EMAIL || 'contact@ulmind.com'}`,
    }
  ];
